const cardsArray = [
    {
        ...
        country1: {
            countryFlag: 'media/oman.png',
            countryName: 'Oman',
            score: '47 (13.2)',
        },
        country2: {
            countryFlag: 'media/england.png',
            countryName: 'England',
            score: '50/2 (3.1)',
        },
        result: {
            resultTitle: "ENG won by 8 wickets",
            matchImage: 'media/englandOman.jpg'
        }
    },
    {
        staging: {
        ...
        country1: {
            countryFlag: 'media/papuaCont.png',
            countryName: 'Papua New Guinea',
            score: '95 (19.5)',
        },
        country2: {
            countryFlag: 'media/afghan.png',
            countryName: 'Afghanistan',
            score: '101/3 (15.1)',
        },
        result: {
            resultTitle: "AFG won by 7 wickets (29 balls left)",
            matchImage: 'media/afghanandpapa.jpeg'
        }
    },
    {
        staging: {
        ...
        country1: {
            countryFlag: 'media/bangla.png',
            countryName: 'Bangladesh',
            score: '159/5 (20)',
        },
        country2: {
            countryFlag: 'media/netherland.png',
            countryName: 'Netherlands',
            score: '134/8 (20)',
        },
        result: {
            resultTitle: "BAN won by 25 runs",
            matchImage: 'media/banglaNether.jpg'
        }
    },
    {
        staging: {
        ...
        country1: {
            countryFlag: 'media/westInd.png',
            countryName: 'West Indies',
            score: '149/9 (20)',
        },
        country2: {
            countryFlag: 'media/newzeland.png',
            countryName: 'Newzeland',
            score: '136/9 (20)',
        },
        result: {
            resultTitle: "WI Won by 13 runs",
            matchImage: 'media/westIndNews.jpg'
        }
    },
    {
        staging: {
